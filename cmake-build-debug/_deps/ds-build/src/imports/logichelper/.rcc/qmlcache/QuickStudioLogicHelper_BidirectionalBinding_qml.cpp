...
0xb4,0xb,0x0,0x0,0x33,0x32,0x33,0x38,
...
aotContext->initGetObjectLookup(31, r2_1, QMetaType::fromType<QObject *>());
if (aotContext->engine->hasError())
    return static_cast<QObject *>(nullptr);
}
// generate_Ret
...
// generate_GetLookup
while (!aotContext->getObjectLookup(37, r2_1, &r2_1)) {
aotContext->setInstructionPointer(4);
aotContext->initGetObjectLookup(37, r2_1, QMetaType::fromType<QObject *>());
if (aotContext->engine->hasError())
    return static_cast<QObject *>(nullptr);
}
// generate_Ret
