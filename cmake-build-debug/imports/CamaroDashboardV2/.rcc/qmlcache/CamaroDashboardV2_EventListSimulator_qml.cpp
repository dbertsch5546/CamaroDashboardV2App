...
0xc0,0x7,0x0,0x0,0x33,0x32,0x33,0x38,
...
r2_2 = QUrl(QStringLiteral("EventListModel.qml"));
// generate_StoreReg
r14_1 = r2_2;
// generate_CallPropertyLookup
{
...
{
QUrl callResult;
void *args[] = { &callResult, &r14_1 };
const QMetaType types[] = { QMetaType::fromType<QUrl>(), QMetaType::fromType<QUrl>() };
while (!aotContext->callObjectPropertyLookup(4, r11_1, args, types, 1)) {
